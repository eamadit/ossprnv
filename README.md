...
A quality indicator combining machine learning on cheating techniques, number of views, social interaction, user data and other high quality data will determine the disk space of each user like an elitist algorithm.
